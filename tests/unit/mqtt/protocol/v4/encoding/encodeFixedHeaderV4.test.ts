  ...
  describe("validation", () => {
    ...
    describe("flags", () => {
      ...
      describe("[MQTT-2.2.2-1]", () => {
        ...
        it("should throw when CONNACT has invalid flags", () => {
          invalidFlags.forEach((flags) => {
            const fixedHeader: FixedHeader = {
        ...
        it("should throw when PUBACK has invalid flags", () => {
          invalidFlags.forEach((flags) => {
            const fixedHeader: FixedHeader = {
        ...
        it("should throw when PUBREC has invalid flags", () => {
          invalidFlags.forEach((flags) => {
            const fixedHeader: FixedHeader = {
        ...
        it("should throw when PUBCOMP has invalid flags", () => {
          invalidFlags.forEach((flags) => {
            const fixedHeader: FixedHeader = {
        ...
        it("should throw when SUBACK has invalid flags", () => {
          invalidFlags.forEach((flags) => {
            const fixedHeader: FixedHeader = {
        ...
        it("should throw when UNSUBACK has invalid flags", () => {
          invalidFlags.forEach((flags) => {
            const fixedHeader: FixedHeader = {
      ...
      describe("[MQTT-3.3.1-4]", () => {
        it("should throw when PUBLISH has QoS 3", () => {
          const fixedHeader: FixedHeader = {
            packetType: PacketType.PUBLISH,
      ...
      // [MQTT-3.14.1-1]
      describe("[MQTT-3.14.1-1]", () => {
        it("should throw when DISCONNECT has invalid flags", () => {
          [
            0b0001, 0b0010, 0b0011, 0b0100, 0b0101, 0b0110, 0b0111, 0b1000,
            0b1001, 0b1010, 0b1011, 0b1100, 0b1101, 0b1110, 0b1111,
          ].forEach((flags) => {
